...
def build_event(summary, description, start, end, stamp, location,
        freq_of_recurrence, until):

    '''
    Return an event that can be added to a calendar

    summary: Summar of the event
    description, location: self explanatory
...
generateIndiaTime(2016, 8, 22, 21, 0), 
"imaginary location!",
"weekly",
